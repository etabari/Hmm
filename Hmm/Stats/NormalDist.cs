...
namespace CenterSpace.Free
{
  ...
  public class NormalDist
  {
    ...
    private const double MACHINE_EPSILON = 1.0e-12;
    ...
    private const double half = 0.5e0;
    ...
    private const double one = 1.0e0;
    ...
    private const double sixten = 1.60e0;
    private const double sqrpi = 3.9894228040143267794e-1;
    private const double thrsh = 0.66291e0;
    private const double root32 = 5.656854248e0;
    private const double zero = 0.0e0;
